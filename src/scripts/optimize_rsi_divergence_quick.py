...
def main():
    ...
    # 定义参数范围 - 使用较小的范围进行快速测试
    rsi_periods = [14]
    rsi_overbought_levels = [65, 70]
    rsi_oversold_levels = [30, 35]
    divergence_lookbacks = [3, 5]
    price_change_thresholds = [0.003, 0.005]
    rsi_change_thresholds = [1.0, 2.0]
    risk_per_trades = [0.02]
    stop_loss_types = ['atr']
    atr_periods = [14]
    atr_mults = [2.0]
    take_profit_mults = [3.0]
    confirm_bars = [0, 1]
